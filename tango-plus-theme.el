...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-2                    ((,class (:foreground ,choc-3))))
   `(org-level-3                    ((,class (:foreground ,cham-3))))
   `(org-level-4                    ((,class (:foreground ,red-2))))
   `(org-level-5                    ((,class (:foreground ,blue-3))))
   `(org-level-6                    ((,class (:foreground ,choc-3))))
   `(org-level-7                    ((,class (:foreground ,cham-3))))
   `(org-level-8                    ((,class (:foreground ,red-3))))
